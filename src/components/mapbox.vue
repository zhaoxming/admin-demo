<template>
  <div>
    ...
    <mapbox
      access-token="pk.eyJ1Ijoiemhhb3htaW5nIiwiYSI6ImNqY29tcHlldzI1NDYyeW4zbmdneGRpd28ifQ.D9I4Rr992BOEOkuyvFQWhw"
      :map-options="{  style: 'mapbox://styles/mapbox/streets-v9',  center: [-96, 37.8],  zoom: 3}"
...
//        })
      ...
      searchLocation(map, e){
        console.log("根据输入信息查询地址");
        console.log(this.inputValue);
        /* */
        let mapboxcom = this.$refs.mapbox;
        console.log(mapboxcom);
        var geocoder = new MapboxGeocoder({accessToken: Mapbox.accessToken});
        geocoder.query(this.inputValue)
      },
      getReturnValue: function () {
        console.log("获取定位信息")
        var map = mapboxgl.map;
        console.log(mapboxgl.Map.MapboxGeocoder)
        console.log(mapboxgl.AttributionControl)
      },
      showAddress(val) {
        /* infoWindow.close();
         document.getElementById('show_school').checked = false;*/
